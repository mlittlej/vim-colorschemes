...
"set background=dark		" Disabled by me
if version > 580
...
hi FoldColumn   ctermfg=244 ctermbg=none                             gui=None        guifg=#808080       guibg=#282828
...
hi ModeMsg      ctermfg=117 ctermbg=none cterm=bold                  gui=bold        guifg=#87dfff       guibg=#282828
hi MoreMsg      ctermfg=122 ctermbg=none cterm=none                  gui=None        guifg=#87ffdf       guibg=#282828
...
hi Directory    ctermfg=117 ctermbg=none cterm=bold                  gui=bold        guifg=#87dfff       guibg=#282828
...
if version >= 700 " Vim 7.x specific colors
    ...
    hi PmenuSel     ctermfg=117 ctermbg=none cterm=underline         gui=underline   guifg=#87dfff       guibg=#282828
    hi PmenuSbar    ctermfg=116 ctermbg=none cterm=none              gui=None        guifg=#87dfdf       guibg=#282828
...
hi Comment    ctermfg=240 ctermbg=none                               gui=None        guifg=#585858       guibg=#282828
hi Constant   ctermfg=086 ctermbg=none                               gui=None        guifg=#5fffdf       guibg=#282828
hi Identifier ctermfg=080 ctermbg=none cterm=bold                    gui=bold        guifg=#5fdfdf       guibg=#282828
hi String     ctermfg=074 ctermbg=none                               gui=None        guifg=#5fafdf       guibg=#282828
hi Statement  ctermfg=159 ctermbg=none cterm=none                    gui=None        guifg=#afffff       guibg=#282828
hi PreProc    ctermfg=122 ctermbg=none                               gui=None        guifg=#87ffdf       guibg=#282828
hi Function   ctermfg=121 ctermbg=none cterm=bold                    gui=bold        guifg=#87ffaf       guibg=#282828
hi Type       ctermfg=117 ctermbg=none cterm=bold                    gui=bold        guifg=#87dfff       guibg=#282828
hi Special    ctermfg=050 ctermbg=none                               gui=None        guifg=#00ffdf       guibg=#282828
